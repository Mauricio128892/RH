...
import Navbar from './components/Navbar.jsx';    // <-- Añadida .jsx
import Login from './components/Login.jsx';      // <-- Añadida .jsx (¡Esta es la clave para tu error!)
import Employees from './components/Employees.jsx'; // <-- Añadida .jsx
import Perfil from './components/perfil.jsx';    // <-- Añadida .jsx (si tu archivo se llama 'perfil.jsx' en minúsculas)
                                                // Si tu archivo real es 'Profile.jsx', deberías usar './components/Profile.jsx'
                                                // Pero si lo nombraste 'perfil.jsx', esto es correcto.
